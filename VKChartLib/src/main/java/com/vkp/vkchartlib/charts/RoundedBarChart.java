...
import com.vkp.vkchartlib.R;
import com.vkp.vkchartlib.animation.ChartAnimator;
import com.vkp.vkchartlib.buffer.BarBuffer;
import com.vkp.vkchartlib.data.BarData;
import com.vkp.vkchartlib.data.BarEntry;
import com.vkp.vkchartlib.highlight.Highlight;
import com.vkp.vkchartlib.highlight.Range;
import com.vkp.vkchartlib.interfaces.dataprovider.BarDataProvider;
import com.vkp.vkchartlib.interfaces.datasets.IBarDataSet;
import com.vkp.vkchartlib.model.GradientColor;
import com.vkp.vkchartlib.renderer.BarChartRenderer;
...
*/
            ...
            // Modify the drawRoundRect calls to create rounded corners only at the top left and right
                c.drawRoundRect(left, top, right, bottom, mRadius, mRadius, mRenderPaint);

                // Draw border
                if (drawBorder) {
                    // Draw the border only at the top left and right corners
                    if (j == 0) {
                        c.drawLine(left + mRadius, top, right - mRadius, top, mBarBorderPaint);
                    }
                    c.drawLine(left, top + mRadius, left, bottom - mRadius, mBarBorderPaint);
                    c.drawLine(right, top + mRadius, right, bottom - mRadius, mBarBorderPaint);

                    // Draw rounded corners for the border at the top left and right
                    c.drawCircle(left + mRadius, top + mRadius, mRadius, mBarBorderPaint);
                    c.drawCircle(right - mRadius, top + mRadius, mRadius, mBarBorderPaint);
                }
