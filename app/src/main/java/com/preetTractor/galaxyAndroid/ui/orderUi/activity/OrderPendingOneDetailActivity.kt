...
import com.preetTractor.galaxyAndroid.databinding.ActivityOrderPendingOneDetailBinding
...
class OrderPendingOneDetailActivity : AppCompatActivity() {

    lateinit var binding: ActivityOrderPendingOneDetailBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityOrderPendingOneDetailBinding.inflate(layoutInflater)
        ...
        if (Globals.checkForInternet(this)) {
            if (where.equals("under")) {
                binding.apply {
                    ...
                    // Set the background tint of the LinearLayout programmatically
                    val color = ContextCompat.getColor(
                        this@OrderPendingOneDetailActivity,
                        R.color.orange_color
                    )
                    binding.linearCustomerDetails.backgroundTintList = ColorStateList.valueOf(color)
                ...
                binding.apply {
                    ...
                    // Set the background tint of the LinearLayout programmatically
                    val color =
                        ContextCompat.getColor(this@OrderPendingOneDetailActivity, R.color.white)
                    binding.linearCustomerDetails.backgroundTintList = ColorStateList.valueOf(color)
    ...
    private fun setupData(one: OrderOneDetailModel.Data) {
        ...
        binding.tvGrossTotalsShubh.setText(Globals.numberToK("0" /*one.GrossTotal*/))
