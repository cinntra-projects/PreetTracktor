...
class BAPendingOrderPagingAdapter : RecyclerView.Adapter<BAPendingOrderPagingAdapter.ItemViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
        return ItemViewHolder(
            ItemRvPreviousOrdersBinding.inflate(
    ...
    class ItemViewHolder(var binding: ItemRvPreviousOrdersBinding) :
        ...
        fun bind(item: ModelOrderListing.Data, context: Context) {
            ...
            binding.apply {
                ...
                tvMobileNo.text = item.C_Mobile
                tvEmail.text = item.C_Email
