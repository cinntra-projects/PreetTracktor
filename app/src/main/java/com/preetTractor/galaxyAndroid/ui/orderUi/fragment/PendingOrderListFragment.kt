...
import com.preetTractor.galaxyAndroid.databinding.FragmentPendingOrderListBinding
...
class PendingOrderListFragment : Fragment() {
    lateinit var binding: FragmentPendingOrderListBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentPendingOrderListBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun setupRequestForItemList() {
        ...
        viewModel.getOrderListingAllFilter(JsonObject().apply {
