...
import com.preetTractor.galaxyAndroid.databinding.ItemLeaveForApproveBinding
import com.preetTractor.galaxyAndroid.helper.Globals
import com.preetTractor.galaxyAndroid.helper.LeaveDiffCallback


class AllLeaveForTeamAdapter(
    private val itemList: ArrayList<LeaveStatusData>,
    private val context: Context,
    private val showEditButton: Boolean = true
) :
    RecyclerView.Adapter<AllLeaveForTeamAdapter.ItemViewHolder>() {

    private var onStatusBtnClickListener: ((LeaveStatusData, Int) -> Unit)? = null

    fun setonStatusBtnClickListener(listener: (LeaveStatusData, Int) -> Unit) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
        ...
        val binding: ItemLeaveForApproveBinding =
            ItemLeaveForApproveBinding.inflate(inflater, parent, false)
    ...
    override fun onBindViewHolder(holder: ItemViewHolder, position: Int) {
        ...
        when (item.Approval_Status) {
            "Pending" -> {
                ...
                holder.binding.tvLeaveStatus.setOnClickListener { _ ->
    ...
    inner class ItemViewHolder(val binding: ItemLeaveForApproveBinding) :
